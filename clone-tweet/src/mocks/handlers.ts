...
export const handlers = [
  ...
  http.get('/api/trends', ({ request }) => {
    return HttpResponse.json([
      ...
      { tagId: 2, title: '원초', count: 2264 },
      { tagId: 3, title: '투초', count: 3264 },
      { tagId: 4, title: '쓰리초', count: 4264 },
      { tagId: 5, title: '포초', count: 5264 },
      { tagId: 6, title: '파이브초', count: 6264 },
      { tagId: 7, title: '식스초', count: 7264 },
      { tagId: 8, title: '세븐초', count: 8264 },
      { tagId: 9, title: '나인초', count: 9264 },
    ]);
  }),
